<div class="fixed inset-x-0 top-0 z-50">
   <div class="wrapper min-h-16 flex items-center justify-between border-b border-gray-300 dark:border-gray-800">
       <a class="text-xl font-semibold" href="#">{{ config('app.name') }}</a>

       <div>
           <button data-theme-toggle class="grid place-items-center hover:text-primary-500">
